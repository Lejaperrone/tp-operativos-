...
HEADERS := -I"$(DIR)/commons_lib/commons" -I"/usr/include" -I"$(DIR)/BibliotecasCompartidas/Debug" -I"$(DIR)/commons_lib/commons/collections" -I"$(DIR)/YAMA" -I"$(DIR)/DataNode" -I"$(DIR)/Worker" -I"$(DIR)/Master" -I"$(DIR)/FileSystem"          # Cualquier cosa aca hay un ejemplo http://www.network-theory.co.uk/docs/gccintro/gccintro_22.html
...
funcionesWorker.o:
	$(CC) $(CFLAGS) -c $(DIR)/Master/src/funcionesWorker.c -o funcionesWorker.o
